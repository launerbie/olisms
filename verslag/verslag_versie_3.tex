...
\begin{figure}[H]
  ...
  \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{all_metro.png}}
...
\begin{figure}[H]
  ...
  \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{wolff_20_30_40.png}}
...
\begin{figure}[H]
  ...
  \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{wolff_50_60.png}}
  \caption{Average net magnetization (left) and magnetic susceptibility (right) plots obtained with the 
...
\begin{figure}[H]
  ...
  \makebox[\textwidth][c]{\includegraphics[width=0.7\textwidth]{plot_4_data_collapse.png}}
